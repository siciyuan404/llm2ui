 ...
 * Toaster Component
 * 
 * A toast notification component built on sonner library.
 * Supports multiple positions, types (success, error, warning, info),
 * and automatic dismissal with configurable duration.
 * 
