 ...
 * 
 * @module lib/core/component-registry
...
/**
 * Component definition data (可序列化，不包含实际组件)
 * 用于主题配置和数据传输
 */
 ...
 * 包含实际的 React 组件
 */
export interface ComponentDefinition extends ComponentDefinitionData {
...
/**
 * Component Registry Interface (用于解耦)
 * 
 * 定义组件注册表的公共接口，允许主题系统和其他模块
 * 依赖接口而非具体实现。
 * 
 ...
 * - Full-text search
 * 
 * Implements IComponentRegistry interface for decoupling.
 */
