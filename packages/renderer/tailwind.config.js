/**
 * @llm2ui/renderer - Tailwind CSS Configuration
 * 
 * This configuration can be extended in your project's tailwind.config.js
 * to ensure proper styling of LLM2UI renderer components.
 * 
